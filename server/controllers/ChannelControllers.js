...
const secretKey = process.env.MY_SECRET_KEY || "New keys"; // Ensure the key is consistent with encryption
...
export const getChannelMessages = async (req, res, next) => {
    try {
        ...
        const decryptedMessages = messages.map((message) => {
            ...
            if (decryptedContent) {
                const bytes = CryptoJS.AES.decrypt(decryptedContent, secretKey);
